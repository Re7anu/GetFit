...
from app.core.formulas import calculate_age, calculate_bmr, calculate_targets

# 1. Test formulas math
def test_calculate_age():
    birth = date(1995, 7, 21)
    # If today is July 21, 2026:
    age = calculate_age(birth)
    assert age == 31

def test_calculate_targets_maintenance():
    # 80kg male, 180cm, 30 years old, moderately active, maintain goal
    # Age is calculated from birth date. Let's create a date that yields 30 years old.
    today = date.today()
...
# 2. Test registration, login, profile endpoints
